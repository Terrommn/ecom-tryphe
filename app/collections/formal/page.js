...
export const metadata = {
  title: "Formal | Tryphé",
  description: "Fragancias formales para ocasiones especiales. Elegantes, sofisticadas y memorables.",
};

export default async function FormalCollectionPage({ searchParams }) {

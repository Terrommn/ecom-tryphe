...
import { SantorCtaButton } from "../oferta-irresistible/SantorCtaButton";
...
export default async function RetriPage() {
      ...
      <article className="bg-white">
        ...
        <section>
          <div className="relative h-[200px] md:h-[300px] w-full overflow-hidden bg-stone-100">
            ...
            <div className="absolute top-4 left-4">
              <span className="bg-[#27ae60] text-white text-[10px] font-bold uppercase tracking-[0.2em] px-3 py-1.5">
        ...
        <section className="bg-[#faf5ef] py-14 px-6 text-center">
          ...
          <p className="mt-3 text-[15px] text-stone-500 max-w-xs mx-auto leading-relaxed">
            Solo 30 lugares. Una sola ventana.
          </p>
          <div className="mt-8">
